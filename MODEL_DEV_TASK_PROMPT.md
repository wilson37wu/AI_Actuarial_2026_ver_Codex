...
DONE (do NOT redo): Phase 36 Task 2 / gap E1 (live-region announcements) and Phase 36 Task 3 / gap E2 (consolidated global glossary & methodology explainer, contract 1.21.0) — see `PHASE36_TASK2_E1_REPORT.md` and `PHASE36_TASK3_E2_REPORT.md`. The single next `in_progress` item is **Phase 36 Task 4 = E3** (reproducibility evidence-pack export); confirm against `.claude-dev/MODEL_DEV_STATE.json`.
