...
EXPECTED_CONTRACT = "1.18.0"
PRIOR_CONTRACT = "1.17.0"
GOVERNED_HEADLINE = "39975.654628199336"

# The 22 substantive top-level sections the manifest must guard (the contract
# at 1.17.0; the manifest itself is additive on top and is NOT in this list).
...
def validate_h1(repo_root: str = ".") -> Dict[str, Any]:
    ...
    checks["contract_is_1_18_0"] = bool(data) and data.get("contract_version") == EXPECTED_CONTRACT
    ...
    checks["html_embeds_contract_1_18_0"] = '"contract_version": "1.18.0"' in html
