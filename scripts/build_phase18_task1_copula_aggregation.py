...
def main() -> int:
    ...
    with open(os.path.join(OUT_DIR, "PHASE18_COPULA_AGGREGATION_REPORT.json"), "w") as fh:
        json.dump(d, fh, indent=2, sort_keys=True)
    with open(os.path.join(OUT_DIR, "PHASE18_COPULA_AGGREGATION_REPORT.md"), "w") as fh:
        fh.write(_md(d))
